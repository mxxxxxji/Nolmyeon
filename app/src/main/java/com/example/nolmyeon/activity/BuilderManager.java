...
public class BuilderManager {
    private static int[] imageResources = new int[]{
            R.drawable.bf_change_apple_s,
            R.drawable.bf_change_berry_s,
            R.drawable.bf_change_choco_s,
            R.drawable.bf_change_kiwi_s,
            R.drawable.cat,
            R.drawable.deer,
            R.drawable.bf_launcher_bana_catch,
            R.drawable.eagle,
            R.drawable.bf_launcher_berry_catch,
            R.drawable.elephant,
            R.drawable.bf_launcher_kiwi_catch,
            R.drawable.bf_change_apple_s,
            R.drawable.bf_change_kiwi_s,
            R.drawable.bf_launcher_kiwi_catch,
            R.drawable.bf_change_apple_s,
